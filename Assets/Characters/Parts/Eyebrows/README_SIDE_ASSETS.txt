...
Naming (same pattern as Body/Top: direction in the name):
  • Front (already present):  eyebrows_straight_01.png
  • Side (east/west):         eyebrows_side_straight_01.png

The same side sprite is used for both east and west; west is drawn with flipX.
Until you add eyebrows_side_straight_01.png, the front sprite is used for side view.
